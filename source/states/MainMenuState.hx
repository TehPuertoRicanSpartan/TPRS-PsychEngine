...
class MainMenuState extends MusicBeatState
{
	...
	public static var tprsForkBuildDate:String = '10/09/2023-3'; // date format: mm/dd/yyyy-b
	...
	override function create()
	{
		...
		var versionShit:FlxText = new FlxText(12, FlxG.height - 64, 0, "TehPuertoRicanSpartan's Fork Build " + tprsForkBuildDate, 12);
